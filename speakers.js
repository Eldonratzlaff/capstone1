const speakerArr = [
    {
        id:0,
        image:'../capstone1/images/speaker1.png',
        name:'Yochai Benkler',
        description:'Benkler studies commons-based peer production, and published his seminal book, The Wealth of Networks in 2006',
    },
    {
        id:1,
        image:'../capstone1/images/speaker2.png',
        name:'Kilnam Chon',
    ...
    {
        id:2,
        image:'../capstone1/images/speaker3.png',
        name:'SohYeong Noh',
...
const addSpeakerArr = [
    {
        id:3,
        image:'../capstone1/images/speaker4.png',
        name:'Yochai Benkler',
        description:'Benkler studies commons-based peer production, and published his seminal book, The Wealth of Networks in 2006',
    },
    {
        id:4,
        image:'../capstone1/images/speaker5.png',
        name:'Kilnam Chon',
        description:'Kilnam Chon helped bring the internet to Asia and is an outspoken advocate for the open web and digital com-mons. In 2012. he was inducted into the inaugural class of the Internet Society’s (ISOC) Internet Hall of Fame',
    },
    {
        id:5,
        image:'../capstone1/images/speaker6.png',
        name:'SohYeong Noh',
        description:'As the main venue for new media art production in Korea, Nabi promotes cross-disciplinary collaboration and understanding among science technology, humanities, and the arts.',
    }
];
